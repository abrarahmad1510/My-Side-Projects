...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2022 at 06:44 AM
...
INSERT INTO `tasks` (`tid`, `uid`, `description`, `start_date`, `end_date`, `status`, `file_name`) VALUES
(1, 1, 'Make the presentation for the upcoming meeting.', '2022-08-03', '2022-08-06', 'Not Started', 'IA_Syllabus.pdf'),
(2, 1, 'Prepare the list of all the absent employees.', '2022-08-03', '2022-08-06', 'Complete', NULL),
(7, 2, 'Task goes here.', '2022-07-31', '2022-08-02', 'Not Started', NULL);
